...
function Search()
{
    ...
    function onChangeHandler(value)
    {
        ...
        else
        {
            ...
            <div className="my-2 h-6 broder-4 overflow-hidden">
                <a className="link w-full ml-1 mr-2 my-2 hover:text-blue-700 text-black-400" rel="noreferrer" target="_blank" href={item[1].url} key={item[1].id}> 
    ...
    return (
    <div className="Search my-4 mx-40">
        <div className="shadow bg-white relative rounded-md flex">
